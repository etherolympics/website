App = {
    ...
    handleCreateTeam: function (event) {
        if (document.querySelectorAll('#selections > div:nth-child(1) > a > div > span > h3.Heading.Heading--size3.text-no-select')[0] != null) {
            var c1 = document.querySelectorAll('#selections > div:nth-child(1) > a > div > span > h3.Heading.Heading--size3.text-no-select')[0].innerHTML.slice(0, -5);
            console.log(c1);
        } else {
        ...
        if (document.querySelectorAll('#selections > div:nth-child(2) > a > div > span > h3.Heading.Heading--size3.text-no-select')[0] != null) {
            var c2 = document.querySelectorAll('#selections > div:nth-child(2) > a > div > span > h3.Heading.Heading--size3.text-no-select')[0].innerHTML.slice(0, -5);
            console.log(c2);
        } else {
            alert('Please select six countries!');
            return;
        ...
        if (document.querySelectorAll('#selections > div:nth-child(3) > a > div > span > h3.Heading.Heading--size3.text-no-select')[0] != null) {
            var c3 = document.querySelectorAll('#selections > div:nth-child(3) > a > div > span > h3.Heading.Heading--size3.text-no-select')[0].innerHTML.slice(0, -5);
            console.log(c3);
        } else {
            alert('Please select six countries!');
            return;
        ...
        if (document.querySelectorAll('#selections > div:nth-child(4) > a > div > span > h3.Heading.Heading--size3.text-no-select')[0] != null) {
            var c4 = document.querySelectorAll('#selections > div:nth-child(4) > a > div > span > h3.Heading.Heading--size3.text-no-select')[0].innerHTML.slice(0, -5);
            console.log(c4);
        } else {
            alert('Please select six countries!');
            return;
        ...
        if (document.querySelectorAll('#selections > div:nth-child(5) > a > div > span > h3.Heading.Heading--size3.text-no-select')[0] != null) {
            var c5 = document.querySelectorAll('#selections > div:nth-child(5) > a > div > span > h3.Heading.Heading--size3.text-no-select')[0].innerHTML.slice(0, -5);
            console.log(c5);
        } else {
            alert('Please select six countries!');
            return;
        ...
        if (document.querySelectorAll('#selections > div:nth-child(6) > a > div > span > h3.Heading.Heading--size3.text-no-select')[0] != null) {
            var c6 = document.querySelectorAll('#selections > div:nth-child(6) > a > div > span > h3.Heading.Heading--size3.text-no-select')[0].innerHTML.slice(0, -5);
            console.log(c6);
        } else {
            alert('Please select six countries!');
            return;
